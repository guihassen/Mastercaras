...
- **PIX turbinado pela Reservinha:** o dinheiro **rende até o instante do débito**.
...
- Valor que **vale a partir de 1 cartão** (ou até zero, via PIX Turbinado), com modo turbo para quem tem portfólio.
...
- **À vista que rende** (débito / PIX Turbinado / Reservinha) — o dinheiro rende até o débito;
- **Crédito à vista** (crédito pago integral, sem juros) — mais cashback + proteção + intercâmbio;
- **Crédito parcelado** (quando a Helena escolhe dividir — ver faixa 3 abaixo).

Considerando: **benefício/cashback** no setor, **rendimento**, **proteção** (entra **só** quando faz sentido — lojista novo, ticket alto, online — nunca no pãozinho) e o **Score** da Helena.

> **Por que vale com 1 cartão:** mesmo com um único cartão de crédito, ainda existe a decisão "pago no crédito à vista pra ganhar cashback ou à vista da Reservinha pra render?". Com 1 cartão, o Autopilot já otimiza **trilhas**; com vários cartões, ele liga o **modo turbo** e otimiza também entre eles. O PIX Turbinado (item 3) entrega valor até com **zero cartão**.
...
#### 3. PIX Turbinado com a Reservinha
Hoje, para pagar à vista, a Helena deixa dinheiro parado na conta corrente (rende zero) ou resgata da Reservinha. No **PIX Turbinado**, o saldo fica na **Reservinha rendendo até o instante em que a transação é liquidada e o valor é debitado**. Ela paga o PIX normalmente; por trás, o dinheiro trabalhou até o último centavo sair.
- Para PIX **agendado** (2% dos PIX) e para a janela de liquidação, o rendimento se estende ainda mais.
- Resultado: **pagar à vista deixa de ser a opção que menos rende e passa a ser a que mais rende** — exatamente o que um perfil à-vista e avesso a risco quer.
...
|-------|----------------|---------------------|--------------------|
| **À vista que rende** (Débito / PIX Turbinado / Reservinha) | Pagamento imediato, sem fatura, dinheiro rendendo | Zero dívida + rendimento até o débito | Retém AUM, dado, mantém o fluxo no ecossistema |
...
**O que sobe o score:** % do gasto pelo Priceless Pay · saldo mantido na Reservinha (AUM) · PIX roteados pelo PIX Turbinado · nº de produtos · pagamento da fatura em dia · tempo de relacionamento.
...
> **7h — Padaria.** Café R$8. Helena aproxima o celular (Apple Pay, credencial Priceless). O Autopilot vê que o ótimo é à vista da Reservinha (ticket baixo, rendeu até agora) e debita de lá. Aviso: *"Pago da Reservinha, que rendeu até agora."*
...
> **20h — PIX para o encanador (PJ).** R$300. **PIX Turbinado:** o valor rendeu na Reservinha até a liquidação; como é lojista novo, o Autopilot ativa a **proteção** automaticamente.
>
...
> **Para o banco:** recuperou o fluxo que vazava no PIX, faturou intercâmbio no crédito à vista, reteve AUM na Reservinha, subiu o score (mais concentração) e virou o banco principal da Helena.
...
| AUM na Reservinha | Em fuga (resgate recorde 2025Q4) | Crescente e estável |
...
1. **Reter o valor no ecossistema** mesmo quando é PIX (PIX Turbinado → AUM + dado).
...
- Lançar **PIX Turbinado** (Reservinha rende até o débito) → estanca a fuga de AUM (resgate recorde de R$1.632k em 2025Q4).
...
**Piso universal (vale para 0–1 cartão):** PIX Turbinado + Score sustentam valor real sem depender de portfólio. Ninguém fica de fora.
...
```
Mais gasto pelo Priceless Pay
      ↓
Mais crédito à vista → mais intercâmbio + mais AUM na Reservinha
      ↓
...
**Três fontes, nenhuma cobrada na transação do cliente:**
...
2. **A virada (1,5 min):** Priceless Pay — pagamento pelo celular + Autopilot + PIX Turbinado + Score, com o exemplo da Helena.
